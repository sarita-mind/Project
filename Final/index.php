...
<?php 
    ...
    $all = 'SELECT * FROM (showinfo s JOIN showtime t ON s.ShowID = t.ShowID) JOIN location l ON s.locationID = l.LocationID  GROUP BY s.ShowID HAVING MIN(t.ShowDateTime) < CURDATE() ORDER BY SaleDate';
