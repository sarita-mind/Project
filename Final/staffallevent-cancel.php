<?php 
    ...
    showtime t ON o.showtimeID = t.ShowtimeID WHERE o.Status = 0 GROUP BY o.BookingID;';
...
<?php include_once('staffheader.php'); ?>
    ...
    <div class="ordertable">
        <div class="card mt-2">
                ...
                <a href="staffallevent-cancel.php" role="button" class="btn btn-outline-secondary btn-sm active">Cancel</button></a>
                </div>
