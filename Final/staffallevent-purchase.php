<?php 
    ...
    showtime t ON o.showtimeID = t.ShowtimeID WHERE o.Status = 2 GROUP BY o.BookingID;';
...
<?php include_once('staffheader.php'); ?>
    ...
    <div class="ordertable">
        <div class="card mt-2">
                ...
                <a href="staffallevent.php"><button type="button" class="btn btn-outline-secondary btn-sm">Not Purchase</button></a>
                <a href="staffallevent-purchase.php" role="button" class="btn btn-outline-secondary btn-sm active">Purchase</button></a>
