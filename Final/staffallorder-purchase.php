<?php 
    ...
    JOIN user u ON o.UserID = u.UserID WHERE o.Status = 2 GROUP BY o.OrderID;';
...
<?php include_once('staffheader.php'); ?>
    ...
    <div class="ordertable">
        <div class="card mt-2">
                ...
                <a href="staffallorder-purchase.php" role="button" class="btn btn-outline-secondary btn-sm active">Purchase</button></a>
