...
$(document).ready(function() {
    let newZoneHTML = `
        <div class='box'>
            ...
            <input class='form-control mt-2' type='text' name='zone_name[]' value='' />
            <label>Zone Price:</label>
            <input class='form-control mt-2' type='text' name='zone_price[]' value='' />
            ...
            <input class='form-control mt-2' type='text' name='zone_capacity[]' value='' />
        </div>`;

    $('#add-zone').click(function() {
        $('#zones-container').append(newZoneHTML);
    });
});
